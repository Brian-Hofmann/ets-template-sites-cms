# ETS Template Sites CMS

This is the CMS repository for [ETS Template Sites](https://github.com/Brian-Hofmann/ets-template-sites).

## Running Locally

Add a file called ".env" to the root folder and put the following contents which is normally generated from the directus init command

The necessary properties to set are the uncommented DB_*, KEY, and SECRET
...
With that complete, you can run "npm run start" which will bootstrap the database if needed and then start directus
